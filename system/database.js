module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '@nanz'
      ...
      if (!('owners' in setting)) setting.owners = ['6285880029379']
      ...
      if (!('cover' in setting)) setting.cover = 'https://i.ibb.co/6H4pfcZ/20230430-183613.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/EQe9Gd5DV6q1Y9ttntySqi'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: true,
         ...
         online: true,
         onlyprefix: '+',
         owners: ['6285880029379'],
         lastReset: new Date * 1,
         msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://api.neoxr.my.id\n◦ *Source* : https://github.com/neoxr/neoxr-bot\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         menuStyle: 4,
         cover: 'https://i.ibb.co/6H4pfcZ/20230430-183613.jpg',
         link: 'https://chat.whatsapp.com/EQe9Gd5DV6q1Y9ttntySqi'
      }
   }
}